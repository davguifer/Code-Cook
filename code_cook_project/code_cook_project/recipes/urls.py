...
from . import views
from recipes.whoosh_config.whoosh_config import load_index, search_recipes_by_title, search_recipes_by_time, search_recipes_by_cooking_time, search_recipes_by_prep_time, search_recipes_by_total_time, search_recipes_by_ingredients_and_total_time, search_recipes_by_difficulty_or_rating, search_top_recipes, quick_recipes, easy_recipes
...
urlpatterns = [
    ...
    path('search/search-by-difficulty-or-rating', search_recipes_by_difficulty_or_rating, name='search_recipes_by_difficulty_or_rating'),
